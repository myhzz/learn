...
import cn.yu.app.R;
import cn.yu.app.util.MyFragmentAdapter;
...
public class MainActivity extends Fragment implements OnCheckedChangeListener {
	private View view;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = inflater.inflate(R.layout.activity_main_page, null);
		initView();
		initListener();
		return view;
	}
